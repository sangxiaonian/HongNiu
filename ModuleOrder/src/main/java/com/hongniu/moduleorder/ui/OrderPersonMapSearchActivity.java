 ...
 */
@Route(path = ArouterParamOrder.activity_order_person_map_search)
public class OrderPersonMapSearchActivity extends RefrushActivity<PoiItem> implements View.OnClickListener, MapPointFragment.OnMapPointChangeListener, SearchTextWatcher.SearchTextChangeListener, MapUtils.OnMapChangeListener, ItemTextView.OnCenterChangeListener, OnItemClickListener<PoiItem> {
